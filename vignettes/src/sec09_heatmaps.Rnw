...
Interactions <- HD2013SGIdata("Interactions")
mainEffects <- HD2013SGIdata("mainEffects")
nrOfInteractionsPerTarget <- HD2013SGIdata("nrOfInteractionsPerTarget")
...
heatmap.2(C2, col=colorRampPalette(hcl.colors(9,"RdBu"))(255),
