...
featuresPerWell <- HD2013SGIdata("featuresPerWell")
TargetAnnotation <- HD2013SGIdata("TargetAnnotation")
QueryAnnotation <- HD2013SGIdata("QueryAnnotation")
datamatrix <- HD2013SGIdata("datamatrix")
@
...
stabilitySelection <- HD2013SGIdata("stabilitySelection")
